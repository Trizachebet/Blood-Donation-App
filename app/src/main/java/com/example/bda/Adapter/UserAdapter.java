...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       if (user.getType().equals("donor")){
        ...
        holder.bloodGroupsSpinner.setText(user.getBloodgroups());

        Glide.with(context).load(user.getProfilepicurl()).into(holder.userProfilePic);
                                ...
                                reference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        String mMessage = "Hello "+nameOfTheReceiver+", "+nameOfSender+
                                                "would like blood donation from you. Here'shis/her details:\n"
                                                +"Name: "+nameOfSender+ "\n"+
                                                "Phone Number:"+phone+ "\n"+
                                                "Email: " +email+"\n"+
                                                "Blood Group: "+blood+ "\n"+
                                                "Kindly Reach out to him/her. Thank you!\n"
                                                +"BLOOD DONATION APP - HELP TO SAVE A LIFE: DONATE BLOOD";

                                        JavaMailApi javaMailApi = new JavaMailApi(context, mEmail, mSubject,mMessage);
                                        javaMailApi.execute();

                                        //saving IDs of people who sent emails
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView type, userName, userEmail, phoneNumber, bloodGroupsSpinner;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            bloodGroupsSpinner = itemView.findViewById(R.id.bloodGroupsSpinner);
    ...
    private void addNotifications(String receiverId, String senderId){
        DatabaseReference reference = FirebaseDatabase.getInstance()
                .getReference().child("notification").child(receiverId);
