...
import com.example.bda.Model.Notification;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        getUserInfo(holder.notification_profile_pic, holder.notification_name, notification.getSenderId());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public CircleImageView notification_profile_pic;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            notification_profile_pic = itemView.findViewById(R.id.notification_profile_pic);
    ...
    private void getUserInfo(final CircleImageView circleImageView, final TextView nameTextView, String senderId) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(context).load(user.getProfilepicurl()).into(circleImageView);
            }
