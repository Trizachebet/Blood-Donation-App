                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                userInfo.put("search", "recipient"+bloodGroupsSpinner);//you cant add two separate queries on a single statement so you concat
                                ...
                                if(resultUri !=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(RecipientRegistrationActivity.this, "Failed to upload image",Toast.LENGTH_SHORT).show();
                                        }
                                    });
